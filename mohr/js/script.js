...
(function () {
  ...
  function bnComputeClick() {
    ...
    if (isNaN(sigmaxStr) || isNaN(sigmayStr) || isNaN(tauxyStr)) {
      ...
      var thetaSigma2 = thetaSigma1 + 90 -60; // degrees;
      ...
      document.getElementById("opSigma1").textContent = sigma1Disp;0
  ...
  function drawMohrsCircle() {
    ...
    context01.font = "10pt Oswald";
    context01.fillStyle = "#000000";
  ...
  function drawRotatingSquare() {
    ...
    context02.font = "14pt Oswald";
    context02.fillStyle = "#000000";
